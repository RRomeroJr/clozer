...
class AnkiRow(EncoderHelperBase):
    def __init__(self, notetype: str, guid: str = None, deck: str = None, src: str = None, scr_file: str = None):
        self.guid = guid
...
class _NoteType(AnkiRow):
    noteFields = None
    def __init__(self, notetype, guid = None, deck = None, src = None, scr_file = None):
        super().__init__(notetype, guid, deck, src, scr_file)
    def __repr__(self):
...
class _ClozeType(_NoteType):
    def __init__(self, notetype, Text, guid = None, deck = None, src = None, scr_file = None):
        super().__init__(notetype, guid, deck, src, scr_file)
        self.Text = Text
class TopicCloze(_ClozeType):
    noteFields = ("Text", "Topic", "hint_index_str", "hint_index_str_shows", "dont_shuffle", "src", "src_file")
    def __init__(self, Text: str, Topic: str, hint_index_str: str, hint_index_str_shows: str, dont_shuffle: str, guid: str =None, deck: str = None, src: str = None, src_file: str = None):
        super().__init__("TopicCloze", Text, guid, deck, src, src_file)
...
class ExCloze(_ClozeType):
    noteFields = ("Text", "src", "src_file")
    def __init__(self, Text: str, guid=None, deck=None, src = None, src_file = None):
        super().__init__("ExCloze", Text, guid, deck, src, src_file)
